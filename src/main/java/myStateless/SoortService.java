...
/*
 * I'll expose my SLSB as a WS just as testing purposes I might use this to
 * insert soorten through a WS call
...
public class SoortService {
	...
	/*
	 * Here I Inject a non managed DAO SoortDAOI is the interface
	 * 
	 * there is one SoortDAO implmentation in my project named: SoortDAO
	 */
	@Inject
	SoortDAOI soortDAO;

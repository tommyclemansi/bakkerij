...
public class MyAsyncService {
	...
	/*
	 * this is just an attempt for async, but not sure if supported in Web
	 * Profile need to check
	 */

	/*
	 * note here errors are not returned With all Asynchronous, the transaction
	 * context is NOT propagated Security Context is
	 */
	@Asynchronous
